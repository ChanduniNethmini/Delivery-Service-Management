...
import deliveryproducer.DeliveryServicePublish;
import deliveryproducer.DeliveryServicePublishImpl;
...
//	}
	...
	public void start(BundleContext context) throws Exception {
		...
		DeliveryServicePublish deliveryServicePublish = (DeliveryServicePublish) context.getService(serviceReference);
		...
		{  
			...
			while(true) {
				...
				System.out.println(" ********      THE KING HOTEL      ********* ");
				System.out.println(" *********     --------------    *********** ");
				System.out.println(" ***********                    ************ ");
				System.out.println(" ******************************************* ");
				System.out.println(" ");
				...
				if(choice=="admin") {
					...
					System.out.println("KINGS HOTEL");
	...
	public void stop(BundleContext context) throws Exception {
		System.out.println("KINGS HOTEL-COLOMBO \n Good bye!!");
